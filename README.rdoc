...
on DBconnect.instance().connect(localhost,port,database,username,password) first call
...
Usage: 
  rake import  # imports files from fixtures/table_name.(json|ini) if table 'table_name' already exists
